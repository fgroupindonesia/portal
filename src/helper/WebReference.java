...
public class WebReference {
    ...
    public static final String ALL_EXAM_QUESTION = REMOTE + "examqa/all";
    public static final String ALL_EXAM_STUDENT_ANSWER = REMOTE + "examsa/all";
    public static final String ALL_CERTIFICATE_STUDENT = REMOTE + "certificatestudent/all";
    ...
    public static final String CHECK_TOOLS = REMOTE + "tools/check";
    public static final String DOWNLOAD_TOOLS = REMOTE + "tools/download";

    public static final String PREVIEW_EXAM = REMOTE + "examqa/preview";
    public static final String PICTURE_CERTIFICATE_STUDENT = REMOTE + "certificatestudent/picture";
    public static final String DELETE_PICTURE_CERTIFICATE_STUDENT = REMOTE + "certificatestudent/picture/delete";
    ...
    public static final String DELETE_PICTURE_USER = REMOTE + "user/picture/delete";
    public static final String DELETE_PREVIEW_EXAM = REMOTE + "examqa/preview/delete";
    ...
    public static final String DETAIL_EXAM_QUESTION = REMOTE + "examqa/detail";
    ...
    public static final String DETAIL_EXAM_STUDENT_ANSWER = REMOTE + "examsa/detail";
    public static final String DELETE_EXAM_STUDENT_ANSWER = REMOTE + "examsa/delete";
    public static final String UPDATE_EXAM_STUDENT_ANSWER = REMOTE + "examsa/update";
    public static final String ADD_EXAM_STUDENT_ANSWER = REMOTE + "examsa/add";
    ...
    public static final String DELETE_SIGNATURE = REMOTE + "attendance/signature/delete";

    public static final String DETAIL_CERTIFICATE_STUDENT = REMOTE + "certificatestudent/detail";
    public static final String DELETE_CERTIFICATE_STUDENT = REMOTE + "certificatestudent/delete";
    public static final String UPDATE_CERTIFICATE_STUDENT = REMOTE + "certificatestudent/update";
    public static final String ADD_CERTIFICATE_STUDENT = REMOTE + "certificatestudent/add";
    
    public static final String DETAIL_CLASSROOM = REMOTE + "classroom/detail";
    public static final String DELETE_CLASSROOM = REMOTE + "classroom/delete";
    public static final String UPDATE_CLASSROOM = REMOTE + "classroom/update";
    public static final String ADD_CLASSROOM = REMOTE + "classroom/add";
    
    public static final String DETAIL_PAYMENT = REMOTE + "payment/detail";
    public static final String DELETE_PAYMENT = REMOTE + "payment/delete";
    public static final String UPDATE_PAYMENT = REMOTE + "payment/update";
    public static final String ADD_PAYMENT = REMOTE + "payment/add";
    public static final String DELETE_SCREENSHOT = REMOTE + "payment/screenshot/delete";

    public static final String DETAIL_REPORT_BUGS = REMOTE + "reportbugs/detail";
    public static final String DELETE_REPORT_BUGS = REMOTE + "reportbugs/delete";
    public static final String UPDATE_REPORT_BUGS = REMOTE + "reportbugs/update";
    public static final String ADD_REPORT_BUGS = REMOTE + "reportbugs/add";
